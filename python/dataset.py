...
'''
fun:
      find not empty dictory in default path or input path
...
# for i in range(len(path_dict["dict"]) - 2):
#     # print(os.path.join(path_dict["path"], path_dict["dict"][i]))
# # data_awgn_training = cls_dataset(
# #     os.path.join(path_dict["path"], path_dict["dict"][1]), 
# #     print_ctr = 0)
