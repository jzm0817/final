...
classdef psk_modulation
    ...
    methods 
        ...
        function [modulated_seq, initial_bit, symbol_mapping, modulated_seq_up] = generate_modulated_seq(obj)
            ...
            %% call function 'pskmod' to generate base band modulated signal
            modulated_seq = pskmod(modulate_symbol, obj.order);
